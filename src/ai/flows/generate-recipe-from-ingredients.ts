...
export async function generateRecipeFromIngredients(
  ...
  try {
    ...
    if (error.message?.includes('429') || error.message?.includes('quota')) {
      throw new Error("The AI Chef is currently busy (Rate limit reached). Please wait a moment and try again.");
    }
...
const generateRecipeFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    if (!output) throw new Error("No recipe was generated by the AI.");
    return output;
  }
);
